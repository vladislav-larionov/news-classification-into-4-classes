...
def full_classifier_list(vectorizors):
    return [
        (make_pipeline(*vectorizors, SVC()), f'SVM kernel=rbf'),
        (make_pipeline(*vectorizors, SVC(kernel='linear')), f'SVM linear'),
        (make_pipeline(*vectorizors, SVC(kernel='poly')), f'SVM kernel=poly'),
        (make_pipeline(*vectorizors, SVC(kernel='poly', coef0=0.75)),
         f'SVM kernel=poly coef0=0.75'),
        (make_pipeline(*vectorizors, SVC(gamma=1)),
         f'SVM kernel=rbf gamma=1'),
        (make_pipeline(*vectorizors, SVC(gamma=1, C=10)),
         f'SVM kernel=rbf gamma=1 C=10'),
        (make_pipeline(*vectorizors, SVC(gamma=0.75, C=10)),
        ...
        (make_pipeline(*vectorizors, SVC(kernel='poly', degree=4, coef0=0.7)),
        ...
        (make_pipeline(*vectorizors, SVC(degree=5, coef0=0.75, C=10)),
         f'SVM kernel=rbf degree=5 coef0=0.75, C=10'),
        (make_pipeline(*vectorizors, SVC(degree=5, coef0=0.2)),
         f'SVM kernel=rbf degree=5 coef0=0.2'),
        (make_pipeline(*vectorizors, SVC(kernel='poly', degree=5)),
         f'SVM kernel=poly degree=5'),
        (make_pipeline(*vectorizors, SVC(kernel='poly', degree=5, coef0=0.65)),
        ...
        (make_pipeline(*vectorizors, SVC(kernel='poly', degree=5, coef0=0.7)),
         f'SVM kernel=poly degree=5 coef0=0.7'),
        (make_pipeline(*vectorizors, SVC(kernel='poly', degree=6)),
         f'SVM kernel=poly degree=6'),
        (make_pipeline(*vectorizors, SVC(kernel='poly', degree=6, coef0=0.75)),
         f'SVM kernel=poly degree=6 coef0=0.75'),
        (make_pipeline(*vectorizors, SVC(kernel='poly', degree=6, coef0=0.7)),
         f'SVM kernel=poly degree=6 coef0=0.7'),
        (make_pipeline(*vectorizors, LogisticRegression(max_iter=1000)),
         'LogisticRegression'),
        (make_pipeline(*vectorizors, LogisticRegression(penalty="none", max_iter=1000)),
         'LogisticRegression penalty=none'),
        (make_pipeline(*vectorizors, SVC(class_weight='balanced', )), f'SVM class_weight=balanced kernel=rbf'),
        (make_pipeline(*vectorizors, SVC(class_weight='balanced', kernel='linear')),
         f'SVM class_weight=balanced linear'),
        (make_pipeline(*vectorizors, SVC(class_weight='balanced', kernel='poly')),
         f'SVM class_weight=balanced kernel=poly'),
        (make_pipeline(*vectorizors, SVC(class_weight='balanced', kernel='poly', coef0=0.75)),
         f'SVM class_weight=balanced kernel=poly coef0=0.75'),
        (make_pipeline(*vectorizors, SVC(class_weight='balanced', gamma=1)),
         f'SVM class_weight=balanced kernel=rbf gamma=1'),
        ...
        (make_pipeline(*vectorizors, SVC(class_weight='balanced', gamma=0.75, C=10)),
         f'SVM class_weight=balanced kernel=rbf gamma=0.75 C=10'),
...
def bert_long_classifier_list(vectorizors):
    return [
        (make_pipeline(*vectorizors, SVC()), f'SVM kernel=rbf'),
        (make_pipeline(*vectorizors, SVC(kernel='poly')), f'SVM kernel=poly'),
        (make_pipeline(*vectorizors, SVC(kernel='poly', coef0=0.75)),
...
def bert_short_classifier_list(vectorizors):
    return [
        # (make_pipeline(*vectorizors, SVC(kernel='poly')), f'SVM kernel=poly'),
        # (make_pipeline(*vectorizors, LogisticRegression(max_iter=1000)),
        #  'LogisticRegression '),
